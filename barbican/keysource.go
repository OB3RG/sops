/*
Package barbican contains an implementation of the github.com/getsops/sops/v3/keys.MasterKey interface that encrypts and decrypts the
...
// MasterKey is a Barbican key used to encrypt and decrypt sops' data key.
